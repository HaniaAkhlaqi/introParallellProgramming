...
rm *pgm\n\
"
//allocates a 2D integer array of size N x N and initialize it with zeros. 
...
//randomly initialize two 2D arrays array1 and array2 with a pattern of ones in approximately 10% of the cells.
